...
function fetch_data()  
 {  
      $datenbank = $_POST["datenbanknamequartal1"];
	  $output = '';  
      $conn = mysqli_connect("localhost", "root", "", "kassa");  
      $sql = "SELECT * FROM $datenbank WHERE MONTH(datum) = 01 OR MONTH(datum) = 02 OR MONTH(datum) = 03 ORDER BY datum";  

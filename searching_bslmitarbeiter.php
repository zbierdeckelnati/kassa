...
<div class="container">
		...
		<br>
				...
				<?php
				$sql="SELECT * FROM bslmitarbeiter WHERE datum = '$searching' ORDER BY id DESC";
				...
				$sql="SELECT sum(soll) as totalsoll FROM bslmitarbeiter WHERE datum = '$searching'";
				$result_set=mysqli_query($db_kassa, $sql);
				while ($row = mysqli_fetch_assoc($result_set))
				{?>
				<tfoot>
				...
				$sql="SELECT sum(soll)-sum(haben) as totalsollhaben FROM bslmitarbeiter WHERE datum = '$searching'";
				$result_set=mysqli_query($db_kassa, $sql);
				while ($row = mysqli_fetch_assoc($result_set))
				{?>
